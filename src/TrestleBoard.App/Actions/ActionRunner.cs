...
internal sealed class ActionRunner
{
    ...
    internal ActionRunner(MainWindow window)
    {
        ...
        _handlers = new Dictionary<string, Func<Control?, Task<bool>>>(StringComparer.Ordinal)
        {
            ...
            [ActionId.RecentNewsletters] = Async(() => window.OpenOneYouHadOpenAsync()),
            ...
            [ActionId.PickUpLook] = Sync(window.PickUpTheLook),
            [ActionId.PutLookDown] = Sync(window.PutTheLookDown),
            [ActionId.LineBreak] = Sync(window.InsertLineBreak),
            ...
            [ActionId.EmblemColour] = Async(() => window.ChangeEmblemColourAsync()),
